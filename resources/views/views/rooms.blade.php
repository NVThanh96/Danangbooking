...
{{--end field enter data check--}}
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                    <a href="#" class="hotel">
                        <figure class="img-wrap">
                            <img src="{{ asset('images/hotels/AvoraHotel/avora-boutique.jpg') }}" alt="Free website template" class="img-fluid mb-3">
                        </figure>
                        <div class="p-3 text-center room-info">
                            <h2>Avora Hotel</h2>
                            {{-- if trong cơ sử dữ liệu là 3 sao thì 3 ngôi sao sáng--}}
                            <p>
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                            </p>
                            <span class="text-uppercase letter-spacing-1">752.286 ₫ / per night</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                    <a href="#" class="hotel">
                        <figure class="img-wrap">
                            <img src="{{ asset('images/hotels/sandy/sandy.jpg') }}" alt="Free website template" class="img-fluid mb-3">
                        </figure>
                        <div class="p-3 text-center room-info">
                            <h2>Sandy Beach Non Nuoc Resort
                            </h2>
                            <p>
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                            ...
                            <span class="text-uppercase letter-spacing-1">1.185.600 ₫ / per night</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                    <a href="#" class="hotel">
                        <figure class="img-wrap">
                            <img src="{{ asset('images/hotels/hillton/hilton1.jpg') }}" alt="Free website template" class="img-fluid mb-3">
                        </figure>
                        <div class="p-3 text-center room-info">
                            <h2>Hilton Đà Nẵng</h2>
                            <p>
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                            ...
                            <span class="text-uppercase letter-spacing-1">3.023.598 ₫ / per night</span>
                        </div>
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="100">
                <a href="#" class="image d-block bg-image-2"
                    style="background-image: url({{asset('images/phongngu.jpg')}});"></a>
                <div class="text">
    ...
    <section class="section bg-image overlay" style="background-image: url('../../../public/images/hero_4.jpg');">
        <div class="container">
