...
<section class="section bg-image overlay" style="background-image: url({{ asset('images/hero_3.jpg') }});">
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-md-10">
                <h2 class="heading text-white" style="font-family:Castellar;font-size: 100px" data-aos="fade">tour guide</h2>
                <p class="text-white1" style="color: #c1ab1c;font-size: 25px" data-aos="fade" data-aos-delay="100">Far far away, behind the word
        ...
        <div class="food-menu-tabs" data-aos="fade">
            ...
            <div class="tab-content py-8" id="myTabContent">
