<section style="margin: 0 9%" class="section testimonial-section">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
                <h2 class="heading" style="font-family:Castellar;Color: gray" data-aos="fade-up">People Says</h2>
            </div>
        </div>
        <div class="row">
            <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">

                <div style="font-size: 25px" class="testimonial text-center slider-item">
                ...
                <div style="font-size: 25px" class="testimonial text-center slider-item">
                    <div class="author-image mb-3">
                        <img src="{{ asset('images/person_3.jpg') }}" alt="Image placeholder"
                             class="rounded-circle mx-auto">
                    </div>
                    <blockquote>
